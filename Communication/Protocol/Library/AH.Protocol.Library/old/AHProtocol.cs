...
{
    public class AHProtocol_old : IAHProtocol_old
    {
        ...
        public AHProtocol_old(ushort UID, int timeOut, MessageArriveDelegate messageArrive, IPhysicalProtocolCouple physicalCouple)
        {
            _UID = UID;
            TimeOut = timeOut;
