...
#DEFINE __USB_DESCRIPTORS__
   ...
   #define USB_CONFIG_PID  0x07D0            // PID
#endif

#ifndef USB_CONFIG_VID
   #define  USB_CONFIG_VID 0x1781            // VID
#endif

#ifndef USB_CONFIG_BUS_POWER
   #define  USB_CONFIG_BUS_POWER 100         // 0-500 - Porem 100mA é a corrente máxima que a porta USB entrega
#endif

#ifndef USB_CONFIG_VERSION
   #define  USB_CONFIG_VERSION   0x0100      // 00.00-99.99 - 01.00  Versão da USB, no caso, versão 1.0
#endif

#ifndef USB_CONFIG_HID_TX_SIZE
   #define USB_CONFIG_HID_TX_SIZE   32       // 0-255 - Configurado para trabalhar corretamente com o applicativo
#endif

#ifndef USB_CONFIG_HID_RX_SIZE
   #define USB_CONFIG_HID_RX_SIZE   32       // 0-255 - Configurado para trabalhar corretamente com o applicativo
#endif
