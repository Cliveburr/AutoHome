...
{
    public class ConfigReadRequest : IContentMessage
    {
        public PortType Port { get; } = PortType.CellingFan;
        public byte Msg { get; } = (byte)CellingFanMessageType.ConfigReadRequest;
    ...
    public class ConfigReadResponse : IContentMessage
    {
        public PortType Port { get; } = PortType.CellingFan;
        public byte Msg { get; } = (byte)CellingFanMessageType.ConfigReadResponse;
